...
&= \sum_{k=0}^{\infty} \frac{e^{-1}}{k!}e^{tk}\\
&= e^{-1} \sum_{k=0}^{\infty} \frac{e^{tk}}{k!}\\
&= e^{-1+e^t}
\end{align}
\begin{align}
E\brak{X} &= \left. \frac{d}{dt} M_X(t) \right|_{t=0}\\
&= \left. \frac{d}{dt} e^{-1+e^t} \right|_{t=0}\\
&= \left. e^{-1+e^t+t}\right|_{t=0}\\
&= e^{-1+e^0+0}\\
&= e^{0}\\
&= 1
\end{align}
