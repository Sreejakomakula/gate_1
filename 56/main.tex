...
\begin{align}
M_Y\brak{z} &= E\brak{e^{zx}}\\
&= \sum_{x=0}^{\infty} e^{zx}p_{X}\brak{x}\\
&= \sum_{x=0}^{\infty} e^{zx}\frac{e^{-1}}{x!}\\
&= \sum_{x=0}^{\infty} \frac{e^{-1+zx}}{(x)!}\\
&= e^{-1}\sum_{x=0}^{\infty} \frac{e^{zx}}{(x)!}\\
&= e^{-2(1-e^z)}\\
&= e^{2(e^z-1)}\\
...
Now,
\begin{align}
E\brak{X} &= \sum_{x=0}^{\infty} xp_{X}\brak{x}\\
&= \sum_{x=0}^{\infty} x\frac{e^{-1}}{x!}\\
&= \sum_{x=0}^{\infty} \frac{e^{-1}}{(x-1)!}\\
&= e^{-1}\sum_{x=0}^{\infty} \frac{1}{(x-1)!}\\
&= e^{-1}e\\
&= 1
\end{align}
Therefore, ${E(X) = 1}$.\\
