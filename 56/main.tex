...
\begin{align}
M_Y\brak{z} &= E\brak{z^{-Y}}\\
&= E\brak{e^{zx}}\\
&= \sum_{y=0}^{\infty} e^{zy}p_{Y}\brak{y}\\
&= \sum_{y=0}^{\infty} e^{zy}\frac{e^{-2}2^{y}}{y!}\\
&= \sum_{y=0}^{\infty} \frac{e^{-2+zy}2^{y}}{y!}\\
&= e^{-2}\sum_{y=0}^{\infty} \frac{e^{zy}2^{y}}{y!}\\
&= e^{-2(1-e^z)}\\
&= e^{2(e^z-1)}\\
